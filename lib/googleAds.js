...
export async function uploadClickConversion({
  ...
  try {
    ...
    console.log('Uploading conversion to Google Ads API...')
    console.log('Customer ID:', customerId)
    console.log('Developer Token exists:', !!process.env.GOOGLE_ADS_DEVELOPER_TOKEN)
    console.log('Access Token exists:', !!accessToken)
    
    // Upload via REST API - using v16 (latest stable version)
